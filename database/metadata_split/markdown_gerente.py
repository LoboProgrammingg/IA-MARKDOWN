...
def process_gerentes_markdown(markdown_text, filepath):
    documents = []

    if 'colaborador_unidade_structured.md' in filepath:
        ...
        raise ValueError("❌ O arquivo fornecido não é 'Gerentes.md'.")
