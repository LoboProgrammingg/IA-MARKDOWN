...
def filter_and_combine_documents(
    documents, max_combined_tokens=2000, model='gpt-4o-mini'
):
...
def summarize_documents_in_one_call(
    documents,
    model='gpt-4o-mini',
    max_tokens_summary=700,
    max_combined_tokens=2000,
):
    combined_text = filter_and_combine_documents(
        documents, max_combined_tokens=max_combined_tokens, model=model
    )
